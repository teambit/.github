...
We build open source and products that help people build **composable software** and the [cloud platform](https://bit.dev/) that helps teams and enterprises build at increasing pace.
